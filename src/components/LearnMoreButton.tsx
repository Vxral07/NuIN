...
export const LearnMoreButton: React.FC<LearnMoreButtonProps> = ({ onClick }) => (
  <div 
    className="flex gap-2.5  max-w-full font-poppins text-sm text-white underline leading-tight w-[125px]"
    onClick={onClick}
    role="button"
    tabIndex={0}
  >
    <div className="grow whitespace-nowrap mb-4">Read more</div> {/* Added whitespace-nowrap here */}
