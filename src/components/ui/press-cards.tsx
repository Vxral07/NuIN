        ...
        >
            {items.map((item, idx) => (
                ...
                >
                    ...
                    <Card className="text-center flex bg-stone-950 bg-gradient-to-b from-[#1d1d1f] to-[#0d0d0d] hover:!bg-black hover:!bg-none hover:shadow-[inset_0_0_20px_#0dd3ff] transition-all duration-300 ease-in-out group">
                        <img
                            src={`news/${item.image}`}
                            className="rounded-2xl aspect-square p-2 mx-auto object-contain w-full"
                        />
                        <div>
                            <CardTitle>{item.title}</CardTitle>
                            <p className="text-background text-white font-semibold mt-4 text-md">
...
export const CardTitle = ({
    ...
    return (
        <h4
            className={cn(
                "text-cyan-400 font-bold tracking-wide font-poppins ",
                className
            )}
        >
            {children}
